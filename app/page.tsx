    ...
    <div className="relative flex flex-col items-center justify-center w-screen min-h-screen overflow-hidden bg-black">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center px-6 text-center">
        ...
        <motion.div
          initial={{ scaleX: 0, opacity: 0 }}
          animate={{ scaleX: 1, opacity: 1 }}
          transition={{ duration: 1.5, delay: 1, ease: [0.21, 0.47, 0.32, 0.98] }}
        ...
        >
          <TextReveal
            ...
            delay={0.1}
          >
            Specializing in AWS, automation, and scalable serverless systems. Learning more about AI/ML and cloud native technologies.
          </TextReveal>
        </motion.div>
