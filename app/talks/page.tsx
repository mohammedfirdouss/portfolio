...
export default function TalksPage() {
	...
	return (
		<div>
			<h1 className="font-display text-5xl sm:text-6xl md:text-7xl xl:text-8xl text-gray-200 dark:text-gray-800 mb-8">talks</h1>
			...
			<div className="divide-y divide-gray-100">
				{talks.map((talk) => (
					<div key={talk.slug} className="pt-6 first:pt-0">
						...
						<div className="flex items-center gap-1 flex-wrap text-gray-400 dark:text-gray-500 text-sm mt-1">
							<time>
