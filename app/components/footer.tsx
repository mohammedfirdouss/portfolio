...
const socialLinks = [
  { icon: Github, href: "https://github.com/mohammedfirdouss", label: "GitHub" },
  { icon: Linkedin, href: "https://www.linkedin.com/in/mohammedfirdousaraoye/", label: "LinkedIn" },
  { icon: Twitter, href: "https://twitter.com/iamfirdouss", label: "Twitter" },
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="mt-4 text-zinc-400 max-w-md leading-relaxed">
              Cloud Engineer specializing in AWS, automation, and scalable serverless systems. 
