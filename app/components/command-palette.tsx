...
export function CommandPalette() {
  ...
  const commands: CommandItem[] = [
    ...
    // Social
    {
      ...
      action: () => window.open("https://github.com/mohammedfirdouss", "_blank"),
      category: "social",
    },
    {
      id: "linkedin",
      ...
      action: () => window.open("https://linkedin.com/in/mohammedfirdouss", "_blank"),
      category: "social",
    },
    {
      id: "twitter",
      ...
      action: () => window.open("https://twitter.com/mohammedfirdous", "_blank"),
      category: "social",
    },
  ];
