      ...
      <div className="relative z-10 px-6 pt-24 mx-auto space-y-8 max-w-7xl lg:px-8 md:space-y-16 md:pt-32 lg:pt-40">
        ...
        <div className="max-w-2xl mx-auto lg:mx-0">
          ...
          <p className="mt-6 text-lg text-zinc-400 leading-relaxed">
            A timeline of my professional roles, projects, and the value I've delivered to various organizations.
          </p>
        </div>
        ...
        <div className="relative max-w-4xl mx-auto lg:mx-0">
           ...
           <div className="space-y-12">
            {experiences.map((experience, index) => (
              <div key={experience._id} className="relative pl-0 md:pl-12 group">
                {/* Timeline Dot */}
                           ...
                           <div className="flex flex-wrap items-center gap-x-4 gap-y-2 text-sm text-zinc-400">
                             <div className="flex items-center gap-1.5">
                               ...
                               {experience.companyUrl ? (
                                   <Link href={experience.companyUrl} target="_blank" className="hover:text-emerald-400 transition-colors flex items-center gap-1">
                                      {experience.company}
