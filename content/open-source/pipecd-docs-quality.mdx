...
summary: Fixed spelling and grammar issues across 25 documentation files in PipeCD, improving clarity and professionalism for the CNCF Sandbox project.
date: 2025-11-28
published: true
---
...
Corrected errors across 25 files with 42 additions/deletions:
