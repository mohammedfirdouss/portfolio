...
<div className="my-6 flex flex-col sm:flex-row items-center gap-4">
  <a
    ...
    className="inline-flex w-full sm:w-auto items-center justify-center rounded-md border border-gray-300 bg-white px-4 py-2 text-sm font-medium text-gray-900 no-underline hover:bg-gray-50 hover:border-gray-400 transition-colors"
  >
