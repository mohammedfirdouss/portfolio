...
outcomes:
  - Implemented a reproducible three-tier AWS environment using CloudFormation templates.
  - Applied high-availability design with load balancing, private subnets, and Multi-AZ database setup.
  - Captured infrastructure architecture patterns in code for repeatable environment provisioning.
roleHighlights:
  - I designed the end-to-end VPC and tier separation for security and availability.
