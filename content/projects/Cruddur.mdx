...
<div class="grid grid-cols-1 md:grid-cols-2 gap-4 my-4">
  <img src="/cruddur-screenshot-1.png" alt="Cruddur Screenshot 1" className="rounded-lg" />
  <img src="/cruddur-screenshot-2.png" alt="Cruddur Screenshot 2" className="rounded-lg" />
  <img src="/cruddur-screenshot-3.png" alt="Cruddur Screenshot 3" className="rounded-lg" />
  <img src="/cruddur-screenshot-4.png" alt="Cruddur Screenshot 4" className="rounded-lg" />
</div>
