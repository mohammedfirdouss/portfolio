...
screenshot: "/cruddur-mohammed-firdous.webp"
---
...
![Cruddur architecture overview](/cruddur-mohammed-firdous.webp)

*Figure 1: High-level Cruddur architecture, click to view full size.*

![VPC networking setup](/cruddur-screenshot-1.webp)

*Figure 2: VPC networking with public and private subnets.*

![Frontend hosting on S3 and CloudFront](/cruddur-screenshot-2.webp)

*Figure 3: React frontend on S3 delivered via CloudFront.*

![ALB routing to ECS Fargate](/cruddur-screenshot-3.webp)

*Figure 4: ALB routing traffic to ECS Fargate backend services.*

![CI/CD pipeline with CodePipeline](/cruddur-screenshot-4.webp)

*Figure 5: CI/CD pipeline built with AWS CodePipeline.*

![CodePipeline stages](/cruddur-screenshot-5.webp)

*Figure 6: CodePipeline source, build, and deploy stages.*

![DynamoDB and Lambda data layer](/cruddur-screenshot-6.webp)
