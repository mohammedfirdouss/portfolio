...
<figure class="my-6">
  ...
  <figcaption class="mt-2 text-sm text-zinc-500">Figure 1: Terra Towns architecture, with CloudFront, S3, and Terraform Cloud. Click to view full size.</figcaption>
</figure>
